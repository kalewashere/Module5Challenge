...
class Program
{
    ...
    {
        Library library = new Library("Central Library"); // create library
        Member member1 = new Member("Alice", 1); // create members
        Member member2 = new Member("Bob", 2);

        // Adding books to the library 
        library.AddBook(new Book("The Great Gatsby", "F. Scott Fitzgerald", "9780743273565")); // title, author, isbn
        library.AddBook(new Book("To Kill a Mockingbird", "Harper Lee", "9780446310789"));
        library.AddBook(new Book("1984", "George Orwell", "9780451524935"));

        // Displaying available books
        library.DisplayAvailableBooks(); // call method
